...
//        of the age field. If the parameter is less than 0 or greater than 100, it needs to
//        set the age field value to 0.
//        ● Method named isTeen without any parameters, it needs to return true if the
//        value of the age field is greater than 12 and less than 20, otherwise, return false.
...
//        To check if s String is empty, use the method isEmpty from the String class. For
//        example,firstName.isEmpty() returns true if the String is empty or in other words, when
