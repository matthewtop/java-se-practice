...
//        area (width * length).
//        2. Write a class with the name Cuboid that extends Rectangle class. The class needs
...
//        height all of type double. It needs to call parent constructor and initialize a height field.
